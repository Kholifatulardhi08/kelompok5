...
<html lang="en">
	<head>
		<title>Admin | Edit Dokter Spesialis</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Edit Dokter Spesialis</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Edit Dokter Spesialis</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Dokter Spesialis</h5>
												</div>
