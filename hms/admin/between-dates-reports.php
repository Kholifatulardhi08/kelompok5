...
<html lang="en">
	<head>
		<title>Laporan antar tanggal | Admin</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Laporan antar tanggal | Reports</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Laporan antar tanggal</span>
									</li>
									<li class="active">
										<span>Laporan</span>
									</li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Laporan antar tanggal</h5>
												</div>
