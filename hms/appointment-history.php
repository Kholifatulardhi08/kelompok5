...
<html lang="en">
	<head>
		<title>Pasien | Histori Janji</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Pasien  | Histori Janji</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span> Pasien </span>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th>Janji Tanggal/Waktu</th>
												<th>Tanggal Pembuatan Janji</th>
