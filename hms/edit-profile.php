...
<html lang="en">
	<head>
		<title>Pasien | Edit Profile</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Pasien | Edit Profile</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Pasien </span>
...
{
?>
<h4><?php echo htmlentities($data['fullName']);?> Profile</h4>
...
<div class="form-group">
					...
					<a href="change-emaild.php">Update email id</a>
														</div>
