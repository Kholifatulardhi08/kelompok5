...
<html lang="en">
	<head>
		<title>Pasien  Ulang Password</title>
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> Kel 5 | Pasien Ulang Password</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend>
								Patient Ulang Password
							</legend>
							<p>
								Masukan Email and password Untuk Ulang password.<br />
