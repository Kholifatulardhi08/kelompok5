...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Pasien | Tambah Pasien</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Pasien</span>
...
<div class="form-group">
              ...
              <input type="radio" name="gender" id="gender" value="Female" checked="true">Perempuan
              <input type="radio" name="gender" id="gender" value="male">Laki-Laki
              <?php } else { ?>
              <label>
              <input type="radio" name="gender" id="gender" value="Male" checked="true">Laki-Laki
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Masukkan Data Pasien(Jika Ada)" required="true"><?php  echo $row['PatientMedhis'];?></textarea>
</div>	
<div class="form-group">
<label for="fess">
pembuatan Tanggal
