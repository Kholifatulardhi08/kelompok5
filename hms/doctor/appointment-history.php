...
<html lang="en">
	<head>
		<title>Dokter | Catatan Janji Temu</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Dokter  | Catatan Janji Temu</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Doctor </span>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th>Tanggal / Waktu Janji</th>
												<th>Tanggal Pembuatan Janji Temu</th>
